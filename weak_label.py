...
if __name__ == '__main__':
    ...
    input_folder = '/home/hanchao/acdc_segmenter/acdc_logdir/unet2D_bn_modified_wxent_bn_hanchao/predictions_testset/prediction/'
    preprocessing_folder = 'preproc_data_weak'
