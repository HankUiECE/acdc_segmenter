...
experiment_name = 'unet2D_bn_modified_wxent_bn_hanchao_weak_labels'
...
momentum = None
loss_type = 'weighted_crossentropy_with_weak_labels'  # crossentropy/weighted_crossentropy/dice/dice_onlyfg
