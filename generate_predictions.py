...
# Modified by Hanchao Yu for generating predictions for all volumes
        ...
        for folder in os.listdir(input_folder):
            ...
            if os.path.isdir(folder_path):
                ...
                if train_test == 'test':
                    ...
                    for file in glob.glob(os.path.join(folder_path, 'patient???_4d.nii.gz')):
